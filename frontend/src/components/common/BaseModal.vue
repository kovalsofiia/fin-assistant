...
<template>
  <Teleport to="body">
    ...
    >
      <div v-if="isOpen" class="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-gray-900/40 backdrop-blur-sm" @click.self="close">
        <div class="bg-white rounded-t-[2rem] sm:rounded-[2.5rem] w-full max-w-lg shadow-2xl shadow-blue-900/10 overflow-hidden border border-gray-100 flex flex-col max-h-[95vh] sm:max-h-[90vh]">
