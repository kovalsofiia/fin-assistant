...
import TransactionCharts from '@/components/transactions/TransactionCharts.vue';
import { 
...
<template>
  <div class="max-w-6xl mx-auto p-4 sm:p-8 animate-fade-in font-sans">
    <header class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 sm:mb-12">
      ...
      <div class="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
        <button 
          ...
          class="w-full md:w-auto px-4 py-3 sm:px-6 sm:py-4 rounded-2xl font-black transition-all flex items-center justify-center gap-2"
    ...
    <!-- Analytics Overview Section Extracted -->
    <TransactionCharts :show="showCharts" />
